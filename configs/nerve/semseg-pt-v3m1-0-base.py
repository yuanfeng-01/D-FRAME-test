...
#     dict(type='MseEvaluator'),
#     dict(type='CheckpointSaver', save_freq=None),
#     dict(type='PreciseEvaluator', test_last=False)
# ]
#
# test = dict(type='MseTester', verbose=True)
#
# # model settings
# model = dict(
#     type="DefaultSegmentorV2",
...
#
# # dataset settings
# dataset_type = "TeethLandDataset"
# data_root = "/data2/lwj/PycharmProjects/MICCAI_TeethLand24/Pointcept/data/teeth_land"
#
# data = dict(
#     num_classes=6,
#     ignore_index=-1,
